...
export default function Mentor({ mentor }) {
  ...
  return (
    <div className="sessions keret padding">
      ...
      <p>
        {mentor.experienceLevel} Developer with {mentor.yearsExperience || 0} years experience
      </p>
...
/*
Mentor komponens összefoglaló:

- Propson kapja a mentor adatait (mentorName, expertise, experienceLevel, sessionDate, durationMinutes, creditCost, isAvailable).
- useContext(MentorContext) segítségével eléri a bookedSession függvényt.
- sessionBooked(): gombnyomásra lefoglalja a session-t, hibát kezel (pl. insufficient credits).
- Betöltés alatt: ha a mentor objektum még nem érkezett meg, loading placeholder jelenik meg.
- Dátum és idő formázása: toLocaleDateString és toLocaleTimeString.
- Gomb: színe és letiltása változik az isAvailable állapottól függően.
*/
